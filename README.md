...
This is a proposed java solution for the Ten-pin bowling coding challenge. I have also considered and implemented the World Bowling and Twelve Frame variants of the game. You can find the necessary specifications in this [wiki](https://github.com/dchiang/ten-pin-bowling/wiki/Ten-pin-Bowling-Java-Challenge-Instructions 'Ten-pin bowling').
